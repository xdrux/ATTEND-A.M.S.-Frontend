...
class StudentInfo extends React.Component {
                        ...
                        fetch("http://localhost:3001/getStudentInfo",
                            {
                                ...
                                body: JSON.stringify({ courseYear: this.props.classId, fullName: this.props.student })
                            })
                            .then(response => response.json())
                            .then(body => {
                                this.setState({
    ...
    viewAction = () => {
        ...
        faceSamplesElement.classList.remove("formItem")
    }
    ...
    handleEditClick = () => {
        ...
        // textAreas[0].placeholder = "e.g. 202012345";
        textAreas[1].placeholder = "e.g. Juan";
        textAreas[2].placeholder = "e.g. Dela Cruz";

        editButton.textContent = "Save";
        editButton.onclick = this.handleAddClick;
            ...
            <div className="Bg">
                <div className={`fade-in ${this.state.isActive ? 'active' : ''}`}>
                    ...
                    <div className="Header">
                        ...
                        <p className="HeaderText">Student Info</p>

                        <div className="addButton" id="editSaveButton" onClick={this.handleEditClick}>
                            <p id="editViewText" className="addButtonText">Edit</p>
                        </div>
                    </div>
                    <form className="formBlock">
                        ...
                        <div className="formItem hidden" id="addSamplesBlock">
                            <label className="FormLabel" htmlFor="middleName">Face Samples</label>
                            <div className="FormTextArea" id="addFaceSamplesButton" onClick={this.showOverlay}><p id="addFSampleText">Change</p></div>
                            <p id='e-courseSection' className='S-Error'></p>
                        </div>
                    </form>
                ...
                <div className="overlay-content">
                    <div id="leftOverlay">
                        <div className="overlayHeader">
                            ...
                            <p id="addFCText">Change Face Samples</p>
                        </div>
...
export default StudentInfoWraper;
